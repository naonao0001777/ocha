    ...
    <div class="container-sm">
        <div class="row justify-content-md-center mt-4">
            ...
            <div class="col-lg-4 col-xs-8 border border-success-subtle">
                <h4 class="text-center p-2">サインイン<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                            svg {
                                fill: #b2f202
                            }
                ...
                <form method="post" action="../routes/route.php" name="login">
                    <div class="mb-3 form-floating">
                        <input type="text" class="form-control" id="userId" name="userId" placeholder="id" autocomplete="off" required>
