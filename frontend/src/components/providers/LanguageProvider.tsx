...
const ja: Dict = {
  ...
  getStarted: 'はじめる',
  features1Title: '最大10個のリンク',
  features1Desc: '厳選したコンテンツを最大10個まで。量より質を重視して、本当に大切なリンクだけを美しく整理できます。',
  ...
  features3Title: 'いつでも自由にコントロール',
  features3Desc: 'アカウント作成から削除まで、すべてがあなたの手の中に。必要に応じて何度でも新しく始められる自由さがあります。',
  privacy: 'プライバシーポリシー',
  terms: '規約',
...
const en: Dict = {
  ...
  features1Title: 'Curated Collection',
  features1Desc: 'Quality over quantity - showcase up to 10 carefully selected links that truly represent you and your brand.',
  features2Title: 'Personal Branding',
  ...
  features3Title: 'Complete Control',
  features3Desc: 'Create, customize, and manage your account with complete freedom. Start fresh anytime you want - your digital presence, your rules.',
