...
const ja: Dict = {
  ...
  logout: 'ログアウト',
  // Home
  heroDescription: 'Ochaでプロフィールページを作成し、リンクとコンテンツを発信しましょう。',
  getStarted: 'はじめる',
  features1Title: 'お茶デザイン',
  features1Desc: '10個までのリンクを、緑色のデザインで、良い印象のプロフィールを作ります。',
  features2Title: '自分だけのプロフィール',
  features2Desc: 'プロフィール画像をアップロードして自分のIDでページを作れます。',
  features3Title: 'シンプル',
  features3Desc: 'ノイズを排したシンプルなUIで、慣れやすいです。',
  privacy: 'プライバシーポリシー',
  terms: '規約',
